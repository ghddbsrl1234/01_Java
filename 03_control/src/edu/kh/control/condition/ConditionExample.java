...
public class ConditionExample { //기능 제공용 클래스
	...
	public void ex4() {
		...
		//1,2,12 겨울 (-15도 이하: "한파 경보" / -12도이하 : "겨울 한파 주의보")
	...
	public void ex6() {
		...
		if(point < 0 || point > 100) { // 범위에서 벗어난 경우
			result = "잘못 입력하셨습니다";
		} else if(point >= 90) { // 100 ~90 사이
			result = "A";
		} else if(point >= 80 ) { // 70~ 80 샤이
			result = "C";
		}else if(point >= 60) { // 60 ~ 70 사이
			result = "D";
		}else { // 1 ~59 사이
			result = "F";
		}
