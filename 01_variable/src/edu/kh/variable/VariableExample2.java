...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		// 변수 값 대입 : 변수에 값을 집어 넣는 것. (== 초기화) == 은 같다라는 뜻.
	...
	//	자료형	변수명;
		...
		// The linteral 10000000000 of type int is out of range
		...
		// 변수 타입인 float과 일치하지 않아 Type misamatch라는 에러 발생
		//-> float의 리터럴 표기법인 f를 붙여서 float 자료형 값임을 나타냄
