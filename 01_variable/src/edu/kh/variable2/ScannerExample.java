...
// java.util.Scanner : java.utill 패키지에서
// Scanner Class(설계도)를 import(수입)

public class ScannerExample {

	public static void main(String[] args) {

		// Scanner : 프로그램 실행 중 키보드 입력을 받을수있게하는 역할
		// Scanner 객체 생성
		// -> 내 프로 그램 안에 스캐너라는 기계를 새로 만드는 것.
		...
		int input1 = sc.nextInt(); // 정수를 입력 받는 곳
