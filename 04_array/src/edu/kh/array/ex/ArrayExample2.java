...
public class ArrayExample2 {
	...
	public void deepCopy() {
		...
		System.out.println("arr : " + copyArr1[2]);
		System.out.println("arr : " + copyArr2[2]);
		System.out.println("arr : " + copyArr3[2]);

	}

	public void createLototoNumber() {
		// 로또 번호 생성기
		// 배열을 이용한 중복데이터 제거 + 정렬
		...
		for (int i = 0; i < lotto.length; i++) {
			...
			lotto[i] = random;
			// 예를들어 random이 8로 나올때 lotto[0] = 8; //[8,0,0,0,0,0]
