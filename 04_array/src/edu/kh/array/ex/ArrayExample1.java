...
public class ArrayExample1 {
	 ...
	 * 배열(Array)
	 * 
	 * - 같은 자료형의 변수를 하나의 묶음으로 다루는것. - 묶여진 변수들은 하나의 배열명으로 불려지고 구분은 index를 이용함 (index는
	 * 0부터 시작하는 정수)
	 * 
	 */
	...
	public void ex1() {
		...
		// 공간 4byte를 활당하고 그 고강간에 num이라는 이름을 부여

		// 변수 대입
		num = 10;
		// 생선된 num이라는 변수공간에 10이라는 정수값 대입
		...
		int[] arr;
		// int arr [];
		// stack 영역에 int[] 자료형 공간을 4byte 활당하고
		...
		arr[1] = 50;
		arr[2] = 100;
		// arr[3] = 500; // 컴파일 에러는 나지 않지만 실행했을때 런타임 에러 발생!
		// 배열 범위 벗어남 에러 발생
		// 실행했을때 콘솔에 나타나는 에러는 런타임 에러
		...
		// [10, 50, 100] 출력하고 싶을 때
		// 실제로 배열이 가진 모든 요소의 값을 알고 싶을 떄
		// Arrays.toString(배열명); 기능 생성 -> String 형
		// "[10, 50, 100]"
